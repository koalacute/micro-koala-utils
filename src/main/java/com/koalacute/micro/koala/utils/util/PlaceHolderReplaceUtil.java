...
public class PlaceHolderReplaceUtil {
    ...
    public static String replaceWithMap(String sourceString, Map<String, String> param) {
        if (StringUtils.isBlank(sourceString) || CollectionUtils.isEmpty(param)) {
            return sourceString;
        }
    ...
    public static String replaceWithObject(String sourceString, Object param) {
        if (StringUtils.isBlank(sourceString) || ObjectUtils.isEmpty(param)) {
            return sourceString;
        }
    ...
    public static Set<String> findPlaceHolderKeys(String sourceString, Pattern pattern) {
        ...
        if (StringUtils.isBlank(sourceString) || ObjectUtils.isEmpty(pattern)) {
